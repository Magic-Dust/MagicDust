...
ADDONTITLE     = '[B][COLOR dodgerblue]Magic Dust[/COLOR][/B] Wizard'
BUILDERNAME    = 'Kodi Fairy'
...
THEME1         = '[COLOR '+COLOR1+'][B][I]([COLOR '+COLOR2+']Magic Dust[/COLOR])[/I][/B][/COLOR] [COLOR '+COLOR2+']%s[/COLOR]'
...
HIDECONTACT    = 'No'
# You can add \n to do line breaks
CONTACT        = 'Teagan and Crispo have lady parts'
...
# Font size of header
FONTHEADER     = 'Font14'
HEADERMESSAGE  = '[B][COLOR dodgerblue]Magic Dust[/COLOR][/B] Wizard'
